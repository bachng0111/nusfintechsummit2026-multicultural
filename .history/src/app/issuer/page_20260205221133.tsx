...
import { saveMarketplaceToken } from '@/lib/tokens-api'
...
export default function IssuerPage() {
  ...
  const handleMint = useCallback(async () => {
    ...
    try {
      ...
      // Save to external storage (API) - this saves to both marketplace and archive
      const saved = await saveMarketplaceToken(tokenData)
      if (!saved) {
        console.warn('[MPT] Failed to save token to external storage, falling back to localStorage')
